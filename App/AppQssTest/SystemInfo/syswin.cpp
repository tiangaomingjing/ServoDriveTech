...
__int64 SysWin::Filetime2Int64(const FILETIME* ftime)
{
	LARGE_INTEGER li;
...
__int64 SysWin::CompareFileTime(FILETIME preTime,FILETIME nowTime)
{
...
bool SysWin::GetSysCpu(int& nCpuRate)
{
	HANDLE hEvent;
	bool res;
...
bool SysWin::GetSysMemory(int& nMemTotal,int& nMemUsed)
{
...
bool SysWin::GetSysDisk(int& nDiskTotal,int& nDiskUsed)
{
...
QMap<int,QString> SysWin::GetAllProcess()
{
...
bool SysWin::GetProcessMemory(int nPid,int& nProcessMemRate)
{
