...
errcode_t ICom::writeRAM(uint8_t axis, uint16_t ofst, uint8_t page, uint64_t value , uint8_t bytesNum)
{
  errcode_t ret=1;
  switch (bytesNum)
  {
...
errcode_t ICom::readRAM(uint8_t axis, uint16_t ofst, uint8_t page, uint64_t &value , uint8_t bytesNum)
{
  errcode_t ret=-1;
  switch (bytesNum)
  {
...
errcode_t ICom::writeFLASH(uint8_t axis, uint16_t ofst, uint8_t page, uint64_t value , uint8_t bytesNum)
{
  errcode_t ret=-1;
  switch (bytesNum)
  {
...
errcode_t ICom::readFLASH(uint8_t axis, uint16_t ofst, uint8_t page, uint64_t &value , uint8_t bytesNum)
{
  errcode_t ret=-1;
  switch (bytesNum)
  {
...
errcode_t ICom::readFPGAReg(uint8_t fpgaInx, uint16_t address, uint64_t &value, uint8_t bytesNum, uint16_t base)
{
  errcode_t ret=-1;
  switch (bytesNum)
  {
...
errcode_t ICom::writeFPGAReg(uint8_t fpgaInx, uint16_t address, uint64_t value, uint8_t bytesNum, uint16_t base)
{
  errcode_t ret=-1;
  switch (bytesNum)
  {
