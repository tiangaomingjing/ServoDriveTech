#ifndef FRAMEITEMWIDGET_H
#define FRAMEITEMWIDGET_H

#include <QWidget>
#include "sdtgraphicsitems_global.h"

class SDTGRAPHICSITEMSSHARED_EXPORT FrameItemWidget : public QWidget
{
    Q_OBJECT
...
public:
    explicit FrameItemWidget(QWidget *parent = 0);
    ~FrameItemWidget();
